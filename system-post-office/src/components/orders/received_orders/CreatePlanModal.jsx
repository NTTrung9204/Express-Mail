...
const CreatePlanModal = ({ open, onClose, selectedOrders, onCreatePlan, loading, isTransfer }) => {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-xl w-[600px] shadow-lg p-6 relative max-h-[80vh] overflow-y-auto">
        ...
        <h2 className="text-xl font-bold text-[#4b1d09] mb-4">
          {isTransfer ? "Phân loại đơn hàng" : "Tạo kết hoạch giao hàng"}
        </h2>
        ...
        {/* Vehicle Input - Only for delivery, not for transfer */}
        {!isTransfer && (
          <div className="mb-6">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            disabled={loading || (!isTransfer && vehicles < 1)}
