...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _login() {
    ...
    if (username.isEmpty || password.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("Đăng nhập: $username / $password")),
      );
                                  ...
                                  overlayColor: WidgetStateProperty.resolveWith(
                                    (states) {
                                      if (states.contains(
                                        ...
                                        return AppColors.gray_EDEFF3.withValues(
                                          alpha: 1.0,
                                        );
                                      }
                                      if (states.contains(
                                ...
                                child: Padding(
                                  ...
                                  child: Text(
                                    _continueLabelCurrent ==
                                        ...
                                        : AppStrings.continue_with_phone_number,
                                    style: TextStyle(
                                      fontFamily: "Inter_bold",
                                      fontSize: 13,
                                      color: AppColors.blue_344256,
                        ...
                        child: DecoratedBox(
                          decoration: BoxDecoration(
                            gradient: const LinearGradient(
                              colors: [
                                AppColors.blue_4D77FD,
                                AppColors.blue_0081FF,
                              ],
                              begin: Alignment.topLeft,
                              end: Alignment.bottomRight,
                            ),
